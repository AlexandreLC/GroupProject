...
Item_threshold = 5 # We need to be able to adjust the relevant nb of items purchased
...
UnRotated_Results<-principal(t(Matrix_segm), nfactors=nrow(Matrix_segm), rotate="none",score=TRUE)
